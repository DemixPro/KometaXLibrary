...
Folder.Name = game:GetService("HttpService"):GenerateGUID(false) .. game:GetService("HttpService"):GenerateGUID(false)

local Solaris = Instance.new("ScreenGui")
Solaris.Name = game:GetService("HttpService"):GenerateGUID(false) .. "KometaX" .. game:GetService("HttpService"):GenerateGUID(false)
